...
const businessAreaList = () =>
    ...
    // 部门资料
const department = () =>
    import ( /* webpackChunkName: "group-businessArea" */ '../components/department/department')
const departmentList = () =>
    import ( /* webpackChunkName: "group-businessArea" */ '../components/department/departmentList')
    // 商品属性
const commodityProperty = () =>
    import ('../components/commodityManagement/commodityProperty')
const commodityPropertyDetails = () =>
    import ('../components/commodityManagement/commodityPropertyDetails')
const commodity = () =>
    import ('../components/commodityManagement/commodity')
const commercial = () =>
    import ('../components/commodityManagement/commercial')
const commodityleimu = () =>
    import ('../components/commodityManagement/commodityleimu')
const Property = () =>
    import ('../components/commodityManagement/Property')
const commercialSpecification = () =>
    import ('../components/commodityManagement/commercialSpecification')
const commercialSpecificationDetails = () =>
...
const classProperty = () =>
    import ('../components/commodityManagement/classProperty')
const classPropertyDetails = () =>
    import ('../components/commodityManagement/classPropertyDetails')
const unitOfMeasurement = () =>
    import ('../components/commodityManagement/unitOfMeasurement')
...
const commodityAttribute = () =>
    import ('../components/commodityManagement/commodityAttribute')
const specificationOfGoods = () =>
    import ('../components/commodityManagement/specificationOfGoods')
const specification = () =>
    import ('../components/commodityManagement/specification')
const specificationOfGoodsList = () =>
    import ('../components/commodityManagement/specificationOfGoodsList')
const specificationOfGoodsDetails = () =>
    import ('../components/commodityManagement/specificationOfGoodsDetails')
const classPropertyList = () =>
    import ('../components/commodityManagement/classPropertyList')
const commodityRecord = () =>
    import ('../components/commodityManagement/commodityRecord')
const Record = () =>
    import ('../components/commodityManagement/Record')
...
let redirectRouter=function(routerName) {//重定向
    ...
    for(let i=0;i<activeRouter.length;i++){
        if(activeRouter[i].name==routerName){
          return activeRouter[i].url;
          break;
>>>>>>> e5997c6819c11baedc4075deccedb8f12e6c6f0c
        }
    }
}
Vue.use(Router)
