            ...
            <div class="btnBd">
                <el-row >
                    ...
                    <el-col :span="24">
                        ...
                        <button class="erp_bt bt_del" @click="confirmDelThis">
                                <div class="btImg">
	        ...
	        <!-- 表单 -->
             <div class="staff_modify_form">
                <el-row style="margin-top:20px">
                    ...
                    <el-col :span="18">
                        <div>
                            <el-input v-model="form.employeeCode" class="employeeCode" @focus="showErrTips" :class="{redBorder : validation.hasError('form.employeeCode')}"  @change="isUpdate"></el-input>
                        </div>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="18">
                        <div>
                            <el-input  @change="isUpdate" v-model="form.employeeName" class="employeeName" @focus="showErrTips" :class="{redBorder : validation.hasError('form.employeeName')}" ></el-input>
                        </div>
                    </el-col>
                </el-row>
                <el-row>
