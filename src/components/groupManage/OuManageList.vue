                ...
                <div class="bgcolor smallBgcolor">
                    ...
                    <el-select clearable v-model="searchData.AreaId" placeholder="">
                        ...
                        <el-input
                            ...
                            <el-tree
                            :render-content="renderContent_AreaId"
                            :default-expanded-keys="expand_AreaId"
        ...
        methods:{
           ...
           openLeft:function(){
            ...
            loadTree(){
               ...
               //地区
                ...
                .then(function(res){
                    ...
                    _this.expand_AreaId=_this.defauleExpandTree(res.result,'id')
                },function(res){
                })
                // //公司
            ...
            delRow(){
                ...
                _this.$axios.posts('api/services/app/OuManagement/BatchDelete',_this.idArray )
                .then(function(res){
                    _this.open('删除成功','el-icon-circle-check','successERP');
                    if(_this.load){
                        _this.loadTableData();
            ...
            renderContent_AreaId(h, { node, data, store }){
