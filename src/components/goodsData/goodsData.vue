<template>
    <div class="goods-data-wrapper">
        <el-row class="pt10 pl10 pb10">
            <el-col :span='2'>
                <span style="font-weight:bolder">基础信息</span>
            </el-col>
            <el-col :span="20">
                <el-row>
                    <el-col :span='5' class="bg-white ml10 h30 pl10">
                        <el-row>
                            <el-col :span="8">
                ...
                <el-row>
                    <el-col :span='5' class="bg-white ml10 h30 pl10 mt10">
                        <el-row>
                            <el-col :span="8">
